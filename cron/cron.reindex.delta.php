...
$Command = PATH_TO_SPHINX_INDEXER." --config ".PATH_TO_SPHINX_CONFIG." ".SPHINX_INDEX_NAME."delta --rotate >> /srv/http/mcuhq/vanilla/plugins/SphinxSearch/cronsphinx_cron.log 2>&1";
exec($Command);